...
public class FindElementById {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.name("username")).sendKeys("tomsmith"); // one line
        Thread.sleep(2000);
        // driver.findElement(By.name("password")).sendKeys("SuperSecretPassword");  // one line
        ...
        WebElement logout = driver.findElement(By.linkText("Logout")); // By.partialLinkText(" Logout")
...
//        driver.findElement(By.id("wooden_spoon")).click();
        ...
        WebElement wrongPasswordLogin=  driver.findElement(By.id("flash"));
        System.out.println(wrongPasswordLogin.getText().replaceAll("[^A-Za-z !]", ""));
